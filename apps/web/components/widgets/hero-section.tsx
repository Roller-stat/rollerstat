    ...
    <section className="relative w-full bg-background overflow-visible pb-14 sm:pb-18 md:pb-24 lg:pb-28 xl:pb-36">
        ...
        <div className="w-full flex items-center justify-center px-8 sm:px-12 md:px-16 lg:px-20 xl:px-24" style={{ height: '50vh' }}>
          <div className="w-full max-w-4xl text-center">
            <div className="flex flex-col justify-center items-center space-y-4">
              {/* Main heading */}
              <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-6xl tracking-tight leading-tight text-foreground dark:text-white uppercase" style={{ fontFamily: '"Castoro Titling", serif' }}>
                {t("headingPart1")} <span className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl text-foreground dark:text-white" style={{ fontFamily: 'var(--font-allura), "Allura", cursive', textTransform: 'capitalize' }}>{t("headingPart2")}</span> {t("headingPart3")} <span className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl text-foreground dark:text-white" style={{ fontFamily: 'var(--font-allura), "Allura", cursive', textTransform: 'capitalize' }}>{t("headingPart4")}</span>.
              </h1>
                ...
                <div className="flex justify-center max-w-64 sm:max-w-72 md:max-w-80 lg:max-w-96 mx-auto">
                  <div className="flex w-full">
                    <Input
                      ...
                      className="flex-[5] rounded-none border-r-0 bg-white dark:!bg-white border-gray-300 text-gray-900 dark:!text-gray-900 placeholder:text-gray-400 dark:placeholder:!text-gray-500 focus:border-gray-400 focus:ring-0 h-8 sm:h-10 md:h-12 lg:h-14 text-xs sm:text-sm md:text-base lg:text-lg"
                    />
                    <Button 
      ...
      <div className="md:hidden flex flex-col h-full relative z-10">
          ...
          <div className="flex-1 flex flex-col justify-center text-center space-y-4 py-12 px-8 sm:px-12 md:px-16 lg:px-20 xl:px-24" style={{ paddingLeft: '3rem', paddingRight: '3rem' }}>
            {/* Main heading */}
            <h1 className="text-2xl sm:text-3xl tracking-tight leading-relaxed text-foreground dark:text-white uppercase" style={{ fontFamily: '"Castoro Titling", serif', lineHeight: '1.8' }}>
              {t("headingPart1")} <span className="text-3xl sm:text-4xl text-foreground dark:text-white" style={{ fontFamily: 'var(--font-allura), "Allura", cursive', textTransform: 'capitalize' }}>{t("headingPart2")}</span> {t("headingPart3")} <span className="text-3xl sm:text-4xl text-foreground dark:text-white" style={{ fontFamily: 'var(--font-allura), "Allura", cursive', textTransform: 'capitalize' }}>{t("headingPart4")}</span>.
            </h1>
              ...
              <div className="flex justify-center max-w-56 sm:max-w-64 mx-auto">
                <div className="flex w-full">
                  <Input
                    ...
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    className="flex-[5] rounded-none border-r-0 bg-white dark:!bg-white border-gray-300 text-gray-900 dark:!text-gray-900 placeholder:text-gray-400 dark:placeholder:!text-gray-500 focus:border-gray-400 focus:ring-0 h-8 sm:h-10 text-[10px] sm:text-sm placeholder:text-[10px] sm:placeholder:text-sm"
                  />
                  <Button 
                    onClick={handleSubscribe}
                    disabled={isLoading || isSubscribed}
